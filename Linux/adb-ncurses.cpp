...
mvprintw(row/2-2,cal/2+tmp,"Htop(BusyBox)");
if(y[2]==1) attron(COLOR_PAIR(1));
else attron(COLOR_PAIR(2));
mvprintw(row/2-1,cal/2+tmp,"Screenrecord");
if(y[2]==2) attron(COLOR_PAIR(1));
else attron(COLOR_PAIR(2));
mvprintw(row/2,cal/2+tmp,"Screenshot");
if(y[2]==3) attron(COLOR_PAIR(1));
else attron(COLOR_PAIR(2));
mvprintw(row/2+1,cal/2+tmp,"Restart sever");
if(y[2]==4) attron(COLOR_PAIR(1));
else attron(COLOR_PAIR(2));
mvprintw(row/2+2,cal/2+tmp,"Restart server(root)");
if(y[2]==5) attron(COLOR_PAIR(1));
else attron(COLOR_PAIR(2));
mvprintw(row/2+3,cal/2+tmp,"Back");
}
