...
printw("~/adb-ncurses/Linux/tmp* -> devices\n");
if(y==4) attron(COLOR_PAIR(2));
else attron(COLOR_PAIR(1));
printw("back\n");
...
break;
case 10:
mvprintw(row/2,cal/2-4,"please, wait");
if(y==1){
system("adb pull /storage/sdcard0 ~/");
}
if(y==2){
system("adb pull /storage/sdcard1 ~/");
}
if(y==3){
system("adb push tmp/* /storage/sdcard0");
}
if(y==4) gg1=true;
break;
}
